...
func (e *Exporter) collect(ch chan<- prometheus.Metric) error {
	...
	if err != nil {
        ...
        ch <- prometheus.MustNewConstMetric(e.processedConnections, prometheus.CounterValue, float64(v), "requests")
        ...
        if len(parts) == 4 {
            ...
            ch <- prometheus.MustNewConstMetric(e.processedConnections, prometheus.CounterValue, float64(v), "request_time")
        }
